...
//
// Usage :
//   node n8n-workflows/topics/new.js <slug> "<label>" "<description>" [mode]
//
// Exemples :
//   node n8n-workflows/topics/new.js f1 "Formule 1" "Grand Prix, écuries, paddock, FIA." fr-intl
//   node n8n-workflows/topics/new.js musique "Musique" "Sorties, concerts, charts FR et international." fr-intl
//   node n8n-workflows/topics/new.js politique "Politique FR" "Vie politique française." fr
//
// Une fois créé :
//   1. Édite configs/<slug>.js (sources, mots-clés, hints).
//   2. Lance :  node n8n-workflows/topics/sync.js
// =========================================================================
...
if (!slugArg || !labelArg) {
  console.error('Usage : node n8n-workflows/topics/new.js <slug> "<label>" "<description>" [mode]');
...
console.log('  2. Lance : node n8n-workflows/topics/sync.js');
console.log('  3. Active le workflow "Recap ' + label + '" dans n8n.');
